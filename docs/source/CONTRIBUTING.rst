...
Contributions to Terraform-Iot-Air-Pollution are welcome.
...
* (IN-698) chore: v10.0
* (IN-698) docs: Add configuration setting
* (IN-698) feat: Create Lambda function
* (IN-698) fix: Retry upload on failure
* (IN-698) refactor: Extract duplicate code
* (IN-698) style: isort, YAPF
* (IN-698) test: Coverage around add permissions
...
.. _Issue: https://luismayta.atlassian.net/projects/IN/issues
.. _Pull Request: https://github.com/luismayta/terraform-iot-air-pollution/pull-requests/
